    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
        <div class="col-md-9 ftco-animate pb-5 text-center">
          <p class="breadcrumbs"><span class="mr-2"><a href="<?= base_url() ?>">Home <i class="fa fa-chevron-right"></i></a></span> <span>Rekomendasi <i class="fa fa-chevron-right"></i></span></p>
      ...
      <div class="row">
        <div class="col-md-4 ftco-animate">
          <div class="project-wrap">
            <a href="<?= base_url('detail') ?>" class="img round" style="background-image: url(assets/images/destination-1.jpg);">
              <span class="price">$550/person</span>
            </a>
            <div class="text p-4">
              <h3><a href="<?= base_url('detail') ?>">Banaue Rice Terraces</a></h3>
        ...
        <div class="col-md-4 ftco-animate">
          <div class="project-wrap">
            <a href="<?= base_url('detail') ?>" class="img" style="background-image: url(assets/images/destination-2.jpg);">
              <span class="price">$550/person</span>
            </a>
            <div class="text p-4">
